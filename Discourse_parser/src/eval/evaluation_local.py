...
class Evaluator(object):
    ...
    def eval_parser(self, path='./examples', report=False, bcvocab=None, draw=False): # changed draw to false by rudra
        ...
        # pickle.dump(cd_articles_brackets, open(path + os.sep + 'cd_article_brackets_' + str(path.split("_")[-1]) + '.p', "wb"))
