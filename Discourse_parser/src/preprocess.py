...
def arg_parse():
    ...
    parser.add_argument('--data_dir', required=False, help='path to data directory.')
    parser.add_argument('--corenlp_dir', required=False, help='path to Stanford Corenlp directory.', default='Discourse_parser/stanford-corenlp-full-2018-10-05')
