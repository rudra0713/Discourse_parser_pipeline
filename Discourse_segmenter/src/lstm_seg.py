...
class LSTMSegModel(BaseSegModel):
    ...
    def _encode(self):
        print("inside the _encode() of lstm_seg.py")
    ...
    def _output(self):
        ...
        self.u = tf_layers.fully_connected(self.encoded_sent, self.hidden_size, tf.nn.relu, scope='output_fc1')
        self.probs = tf.squeeze(tf_layers.fully_connected(self.u, 1, tf.nn.sigmoid, scope='output_fc2'), -1)
