...
def parse_args():
    ...
    parser.add_argument('--gpu', type=bool, default=False, help='specify gpu device')
    ...
    path_settings.add_argument('--rst_dir', default='Discourse_segmenter/data/rst/',
    ...
    path_settings.add_argument('--word_embed_path', default='Discourse_segmenter/data/embeddings/glove.840B.300d.txt',
                               help='the path of the pre-trained word embeddings')
    path_settings.add_argument('--word_vocab_path', default='Discourse_segmenter/data/vocab/word.vocab',
                               help='the path to save vocabulary of words')
    path_settings.add_argument('--model_dir', default='Discourse_segmenter/data/models/',
                               help='the dir to save the model')
    path_settings.add_argument('--result_dir', default='Discourse_segmenter/data/results',
                               help='the directory to save edu segmentation results')
    path_settings.add_argument('--result_file', default='new',
                               help='the name of the edu file')
    path_settings.add_argument('--log_path', default='Discourse_segmenter/log.txt',help='the file to output log')
