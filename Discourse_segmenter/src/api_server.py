...
def segment(args):
    ...
    print("len of articles only -> ", len(articles_only))
    count_done = 0
    print("starting now")
    for key in articles_only:
        count_done += 1
        # if count_done == 441:
        #     print(articles_only[key])
        #     print("........")
        # continue
        # if count_done < 400 or count_done == 442:
        #     continue
        # if count_done == 400:
        #     break
        raw_sents = [articles_only[key]]
    # for file in args.input_files:
    #
    ...
    #                 raw_sents.append(line)
        ...
        for batch in data_batches:
            try:
                ...
                print("batch_pred_segs: ", batch_pred_segs)
            except:
                print("faulty ..")
                continue
    ...
    pickle.dump(edu_output, open(args.result_dir + os.sep + args.result_file + ".p", "wb"))
