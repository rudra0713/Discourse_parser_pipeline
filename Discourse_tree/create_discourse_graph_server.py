...
if __name__ == '__main__':
    ...
    # edu_file_path = '../data/data_stance_createdebate_complete/claim_with_articles_edus_mari.p'
    ...
    edu_file_path = '../data/data_old/claim_with_articles_edus_mari.p'
